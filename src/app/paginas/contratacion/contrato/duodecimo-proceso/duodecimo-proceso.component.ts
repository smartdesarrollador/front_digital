  ...
  modeloContrato(datosTrabajador: any) {
    var docDefinition = {
      content: [
        ...
        {
          text: [
            'El horario de trabajo podrá ser distribuido de lunes a viernes pudiendo ser la jornada laboral de lunes a viernes de 9:00 am a 5:00 pm, incluido los 45 minutos de refrigerio, los cuales no forman parte de la jornada ni del horario de trabajo.  \n\n',
          ],
          style: 'parrafo',
        },
        {
