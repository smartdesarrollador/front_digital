    ...
    content: [
      ...
      },
      {
        text: [
          ...
          ' toda vez que se ha dado un incremento en la producción originados por la variación de la demanda en el mercado debido a ______, lo cual queda evidenciado en documentos como: ______. \n\n',
        ],
        style: 'parrafo',
      },
      {
